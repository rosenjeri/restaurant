                ...
                <div class="widget-content">
                  ...
                  <div class="padd">
                             ...
                             <div class="support-contact">
                                ...
                                <p><i class="fa fa-phone"></i>&nbsp; Phone<strong>:</strong> 0719247154</p>
                                <hr />
                                <p><i class="fa fa-envelope"></i>&nbsp; Gmail<strong>:</strong> restaurantrose@gmail.com</p>
                                <hr />
                                <p><i class="fa fa-home"></i>&nbsp; Address<strong>:</strong>Nairobi </p>
                <hr />
        <p><i class="fa fa-facebook"></i>&nbsp; Facebook<strong>:</strong> facebook.com/Rose Restaurant </p>
                <hr />              
                                <!-- Button -->
